...
function togTrain(cid){
  ...
  if(ex){
    ...
    // Auto-slot u rasporedu sa stvarnim vremenom — schedule sada
    // prikazuje slotove unutar njihovog satnog reda (npr. 6:30 u 6:00 redu).
    slots.push({id:Date.now()+1,cid:cid,date:d.date,time:d.time,dur:60,note:'',auto:true});
